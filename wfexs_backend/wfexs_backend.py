...
class WfExSBackend:
    ...
    def __init__(
        ...
        if baseWorkDir:
            ...
            os.makedirs(baseWorkDir, mode=0o755, exist_ok=True)
        else:
    ...
    def parseOrCreateRawWorkDir(
        ...
        if not os.path.exists(uniqueRawWorkDir):
            ...
            os.makedirs(uniqueRawWorkDir, mode=0o755, exist_ok=True)
